...
int TraCIDemo11pMessage::getTTL() const
{
    return this->TTL;
}

void TraCIDemo11pMessage::setTTL(int TTL)
{
    this->TTL = TTL;
}

::omnetpp::simtime_t TraCIDemo11pMessage::getTimestamp() const
{
    return this->timestamp;
}

void TraCIDemo11pMessage::setTimestamp(::omnetpp::simtime_t timestamp)
{
